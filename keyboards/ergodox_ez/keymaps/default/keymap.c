 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Adjust|  Esc |Option|  Cmd |EISUU |                                       | KANA |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |        |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(
	...
	MO(ADJUST), KC_ESCAPE, KC_LALT, KC_LGUI, KC_LANG2,
	                                                    _______,  _______,
	                                                              _______,
	...
	_______,  KC_N,      KC_M,     KC_COMMA,  KC_DOT,  KC_SLASH,  KC_ENTER,
	                     KC_LANG1, _______,   _______, _______,   _______,
	_______,  _______,
	_______,
...
[RAISE] = LAYOUT_ergodox(
	...
	_______,  _______, _______, _______, _______, _______,  _______,
  _______,  _______, KC_LALT, KC_LGUI, _______,
	                                              _______,  _______, 
	                                                        _______,  
	...
	_______, _______,   _______,  _______,  _______,       _______,           _______,
	                    _______,  _______,  KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP,
	_______, _______,
	_______,
